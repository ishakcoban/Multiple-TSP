    ...
    public void print(boolean verbose) {
        ...
        for (int i = 0; i < table.length; i++) {
            if (i % salesmen == 0) {
                ...
                if (verbose) System.out.println("HUB Number: " + cities[table[i].get(0)]);
                else System.out.println("HUB Number: " + table[i].get(0));
            ...
            for (int j = 1; j < table[i].size(); j++) {
                ...
                if (verbose) System.out.print(cities[table[i].get(j)] + " ");
                else System.out.print(table[i].get(j) + " ");
